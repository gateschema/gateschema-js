...
function _isLeapYear(year: any) {
  // https://tools.ietf.org/html/rfc3339#appendix-C
  return year % 4 === 0 && (year % 100 !== 0 || year % 400 === 0);
}

function date(str: any) {
...
function time(str: string, full?: boolean) {
...
function ipv4(str: string) {
  return IPV4.test(str);
}

function ipv6(str: string) {
